<div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url(''); ?>">Author CSV to Gephi Converter</a>
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li>
                <a href="<?php echo base_url('index.php?/uploadauthors'); ?>">Author Upload</a>
            </li>
            <li>
                <a href="<?php echo base_url('index.php?/convert'); ?>">Convert and Review</a>
            </li>
                    <?php if(strpos($menu, 'dashboard') !== FALSE) : ?>
                        <!-- Dashboard btn -->
                        <li <?php if($controller == 'dashboard') echo 'class="active"'; ?>>
                            <a href="<?php echo base_url('dashboard'); ?>">Upload</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if(strpos($menu, 'cold_storage') !== FALSE) : ?>
                        ...
                        <li <?php if($controller == 'cold_storage') echo 'class="active"'; ?>>
                            <a href="<?php echo base_url('cold_storage'); ?>">Upload authors</a>
                        </li>
                    <?php endif; ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="col-xs-2 col-sm-1">  
                <?php if($controller == 'project'): ?>
                    <span data-toggle="tooltip" data-placement="bottom" 
                            data-original-title="VersionKontrol - Coming soon" 
                            id="myButton">
                    <a href="<?php echo base_url("docs/versionkontrol"); ?>"><img src="<?php echo base_url("upload/cell/treeiconsmall.png"); ?>" style="margin-top:5px"></a>
                    </span>
                <?php endif; ?>
            </div>
            <div class="col-xs-2 col-sm-1">
